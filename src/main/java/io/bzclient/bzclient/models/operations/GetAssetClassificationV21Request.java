...
public class GetAssetClassificationV21Request {
    ...
    @JsonCreator
    public GetAssetClassificationV21Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetAssetClassificationV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetAssetClassificationV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetAssetClassificationV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetAssetClassificationV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetAssetClassificationV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetAssetClassificationV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetAssetClassificationV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetAssetClassificationV21Request other = (GetAssetClassificationV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetAssetClassificationV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetAssetClassificationV21Request build() {
            return new GetAssetClassificationV21Request(
                symbols,
                asOf,
                period,
                reportType);
