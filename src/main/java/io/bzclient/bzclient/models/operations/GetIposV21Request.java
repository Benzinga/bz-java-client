...
public class GetIposV21Request {
     ...
     * Page number
     */
    public GetIposV21Request withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number
     */
    public GetIposV21Request withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Page size
     */
    public GetIposV21Request withPagesize(long pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
     ...
     * Page size
     */
    public GetIposV21Request withPagesize(Optional<Long> pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
        this.pagesize = pagesize;
        return this;
    }
     ...
     * Date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDate(LocalDate parametersDate) {
        Utils.checkNotNull(parametersDate, "parametersDate");
     ...
     * Date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDate(Optional<LocalDate> parametersDate) {
        Utils.checkNotNull(parametersDate, "parametersDate");
        this.parametersDate = parametersDate;
        return this;
    }
     ...
     * Start date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDateFrom(LocalDate parametersDateFrom) {
        Utils.checkNotNull(parametersDateFrom, "parametersDateFrom");
     ...
     * Start date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDateFrom(Optional<LocalDate> parametersDateFrom) {
        Utils.checkNotNull(parametersDateFrom, "parametersDateFrom");
        this.parametersDateFrom = parametersDateFrom;
        return this;
    }
     ...
     * End date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDateTo(LocalDate parametersDateTo) {
        Utils.checkNotNull(parametersDateTo, "parametersDateTo");
     ...
     * End date in YYYY-MM-DD format
     */
    public GetIposV21Request withParametersDateTo(Optional<LocalDate> parametersDateTo) {
        Utils.checkNotNull(parametersDateTo, "parametersDateTo");
        this.parametersDateTo = parametersDateTo;
        return this;
    }
     ...
     * Tickers
     */
    public GetIposV21Request withParametersTickers(String parametersTickers) {
        Utils.checkNotNull(parametersTickers, "parametersTickers");
     ...
     * Tickers
     */
    public GetIposV21Request withParametersTickers(Optional<String> parametersTickers) {
        Utils.checkNotNull(parametersTickers, "parametersTickers");
        this.parametersTickers = parametersTickers;
        return this;
    }
     ...
     * IPO type
     */
    public GetIposV21Request withParametersIpoType(String parametersIpoType) {
        Utils.checkNotNull(parametersIpoType, "parametersIpoType");
     ...
     * IPO type
     */
    public GetIposV21Request withParametersIpoType(Optional<String> parametersIpoType) {
        Utils.checkNotNull(parametersIpoType, "parametersIpoType");
        this.parametersIpoType = parametersIpoType;
        return this;
    }
     ...
     * Updated time in Unix format
     */
    public GetIposV21Request withParametersUpdated(String parametersUpdated) {
        Utils.checkNotNull(parametersUpdated, "parametersUpdated");
     ...
     * Updated time in Unix format
     */
    public GetIposV21Request withParametersUpdated(Optional<String> parametersUpdated) {
        Utils.checkNotNull(parametersUpdated, "parametersUpdated");
        this.parametersUpdated = parametersUpdated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetIposV21Request other = (GetIposV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetIposV21Request.class,
                "page", page,
                "pagesize", pagesize,
    ...
    public final static class Builder {
        ...
        public GetIposV21Request build() {
            return new GetIposV21Request(
                page,
                pagesize,
                parametersDate,
                parametersDateFrom,
