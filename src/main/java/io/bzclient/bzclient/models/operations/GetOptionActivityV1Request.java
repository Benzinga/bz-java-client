...
public class GetOptionActivityV1Request {
    ...
    private Optional<? extends GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort;
     ...
     * ID
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=parameters[id]")
    private Optional<String> parametersId;
    ...
    @JsonCreator
    public GetOptionActivityV1Request(
            Optional<Long> page,
            Optional<Long> pagesize,
            Optional<LocalDate> parametersDate,
            Optional<LocalDate> parametersDateFrom,
            Optional<LocalDate> parametersDateTo,
            Optional<? extends GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort,
            Optional<String> parametersTickers,
            Optional<String> parametersId,
        ...
        Utils.checkNotNull(parametersId, "parametersId");
    ...
    @JsonIgnore
    public Optional<GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort() {
        return (Optional<GetOptionActivityV1QueryParamParametersDateSort>) parametersDateSort;
    }
     ...
     */
    @JsonIgnore
    public Optional<String> parametersId() {
        return parametersId;
    }
     ...
     * Page number
     */
    public GetOptionActivityV1Request withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number
     */
    public GetOptionActivityV1Request withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Page size
     */
    public GetOptionActivityV1Request withPagesize(long pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
     ...
     * Page size
     */
    public GetOptionActivityV1Request withPagesize(Optional<Long> pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
        this.pagesize = pagesize;
        return this;
    }
     ...
     * Date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDate(LocalDate parametersDate) {
        Utils.checkNotNull(parametersDate, "parametersDate");
     ...
     * Date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDate(Optional<LocalDate> parametersDate) {
        Utils.checkNotNull(parametersDate, "parametersDate");
        this.parametersDate = parametersDate;
        return this;
    }
     ...
     * Start date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDateFrom(LocalDate parametersDateFrom) {
        Utils.checkNotNull(parametersDateFrom, "parametersDateFrom");
     ...
     * Start date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDateFrom(Optional<LocalDate> parametersDateFrom) {
        Utils.checkNotNull(parametersDateFrom, "parametersDateFrom");
        this.parametersDateFrom = parametersDateFrom;
        return this;
    }
     ...
     * End date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDateTo(LocalDate parametersDateTo) {
        Utils.checkNotNull(parametersDateTo, "parametersDateTo");
     ...
     * End date in YYYY-MM-DD format
     */
    public GetOptionActivityV1Request withParametersDateTo(Optional<LocalDate> parametersDateTo) {
        Utils.checkNotNull(parametersDateTo, "parametersDateTo");
        this.parametersDateTo = parametersDateTo;
        return this;
    }
     ...
     * Sort by date
     */
    public GetOptionActivityV1Request withParametersDateSort(GetOptionActivityV1QueryParamParametersDateSort parametersDateSort) {
        Utils.checkNotNull(parametersDateSort, "parametersDateSort");
     ...
     * Sort by date
     */
    public GetOptionActivityV1Request withParametersDateSort(Optional<? extends GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort) {
        Utils.checkNotNull(parametersDateSort, "parametersDateSort");
        this.parametersDateSort = parametersDateSort;
        return this;
    }
     ...
     * Tickers
     */
    public GetOptionActivityV1Request withParametersTickers(String parametersTickers) {
        Utils.checkNotNull(parametersTickers, "parametersTickers");
     ...
     * Tickers
     */
    public GetOptionActivityV1Request withParametersTickers(Optional<String> parametersTickers) {
        Utils.checkNotNull(parametersTickers, "parametersTickers");
        this.parametersTickers = parametersTickers;
        return this;
    }
     ...
     * ID
     */
    public GetOptionActivityV1Request withParametersId(String parametersId) {
        Utils.checkNotNull(parametersId, "parametersId");
        this.parametersId = Optional.ofNullable(parametersId);
        return this;
    }
     ...
     * ID
     */
    public GetOptionActivityV1Request withParametersId(Optional<String> parametersId) {
        Utils.checkNotNull(parametersId, "parametersId");
        this.parametersId = parametersId;
        return this;
    }
     ...
     * Updated time in Unix format
     */
    public GetOptionActivityV1Request withParametersUpdated(String parametersUpdated) {
        Utils.checkNotNull(parametersUpdated, "parametersUpdated");
     ...
     * Updated time in Unix format
     */
    public GetOptionActivityV1Request withParametersUpdated(Optional<String> parametersUpdated) {
        Utils.checkNotNull(parametersUpdated, "parametersUpdated");
        this.parametersUpdated = parametersUpdated;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOptionActivityV1Request other = (GetOptionActivityV1Request) o;
        return 
            ...
            Objects.deepEquals(this.parametersId, other.parametersId) &&
    ...
    public String toString() {
        return Utils.toString(GetOptionActivityV1Request.class,
                "page", page,
                "pagesize", pagesize,
    ...
    public final static class Builder {
        ...
        private Optional<? extends GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort = Optional.empty();
 
        private Optional<String> parametersTickers = Optional.empty();
 
        private Optional<String> parametersId = Optional.empty();
         ...
         * Sort by date
         */
        public Builder parametersDateSort(GetOptionActivityV1QueryParamParametersDateSort parametersDateSort) {
            Utils.checkNotNull(parametersDateSort, "parametersDateSort");
            this.parametersDateSort = Optional.ofNullable(parametersDateSort);
            return this;
        }
         ...
         * Sort by date
         */
        public Builder parametersDateSort(Optional<? extends GetOptionActivityV1QueryParamParametersDateSort> parametersDateSort) {
            Utils.checkNotNull(parametersDateSort, "parametersDateSort");
            this.parametersDateSort = parametersDateSort;
            return this;
        }
         ...
         * ID
         */
        public Builder parametersId(String parametersId) {
            Utils.checkNotNull(parametersId, "parametersId");
            this.parametersId = Optional.ofNullable(parametersId);
            return this;
        }
         ...
         * ID
         */
        public Builder parametersId(Optional<String> parametersId) {
            Utils.checkNotNull(parametersId, "parametersId");
            this.parametersId = parametersId;
            return this;
        }
        ...
        public GetOptionActivityV1Request build() {
            return new GetOptionActivityV1Request(
                page,
                pagesize,
                parametersDate,
                parametersDateFrom,
