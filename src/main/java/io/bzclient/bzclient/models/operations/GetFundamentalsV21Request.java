...
public class GetFundamentalsV21Request {
    ...
    @JsonCreator
    public GetFundamentalsV21Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetFundamentalsV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetFundamentalsV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetFundamentalsV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetFundamentalsV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetFundamentalsV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetFundamentalsV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetFundamentalsV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFundamentalsV21Request other = (GetFundamentalsV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFundamentalsV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetFundamentalsV21Request build() {
            return new GetFundamentalsV21Request(
                symbols,
                asOf,
                period,
                reportType);
