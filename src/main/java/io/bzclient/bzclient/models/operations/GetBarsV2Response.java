...
public class GetBarsV2Response implements Response {
     ...
     * HTTP response content type for this operation
     */
    public GetBarsV2Response withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetBarsV2Response withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBarsV2Response withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public GetBarsV2Response withResponseBodies(List<ResponseBody> responseBodies) {
        Utils.checkNotNull(responseBodies, "responseBodies");
     ...
     * OK
     */
    public GetBarsV2Response withResponseBodies(Optional<? extends List<ResponseBody>> responseBodies) {
        Utils.checkNotNull(responseBodies, "responseBodies");
        this.responseBodies = responseBodies;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetBarsV2Response other = (GetBarsV2Response) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetBarsV2Response.class,
    ...
    public final static class Builder {
        ...
        public GetBarsV2Response build() {
            return new GetBarsV2Response(
                contentType,
                statusCode,
                rawResponse,
                responseBodies);
