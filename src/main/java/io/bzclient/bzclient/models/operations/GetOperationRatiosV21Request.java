...
public class GetOperationRatiosV21Request {
    ...
    @JsonCreator
    public GetOperationRatiosV21Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetOperationRatiosV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetOperationRatiosV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetOperationRatiosV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetOperationRatiosV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetOperationRatiosV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetOperationRatiosV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetOperationRatiosV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetOperationRatiosV21Request other = (GetOperationRatiosV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetOperationRatiosV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetOperationRatiosV21Request build() {
            return new GetOperationRatiosV21Request(
                symbols,
                asOf,
                period,
                reportType);
