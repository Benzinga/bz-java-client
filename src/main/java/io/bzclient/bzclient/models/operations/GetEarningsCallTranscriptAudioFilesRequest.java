...
public class GetEarningsCallTranscriptAudioFilesRequest {
    ...
    @JsonCreator
    public GetEarningsCallTranscriptAudioFilesRequest(
     ...
     * Tickers
     */
    public GetEarningsCallTranscriptAudioFilesRequest withTickers(List<String> tickers) {
        Utils.checkNotNull(tickers, "tickers");
     ...
     * Tickers
     */
    public GetEarningsCallTranscriptAudioFilesRequest withTickers(Optional<? extends List<String>> tickers) {
        Utils.checkNotNull(tickers, "tickers");
        this.tickers = tickers;
        return this;
    }
     ...
     * Call ID
     */
    public GetEarningsCallTranscriptAudioFilesRequest withCallId(List<String> callId) {
        Utils.checkNotNull(callId, "callId");
     ...
     * Call ID
     */
    public GetEarningsCallTranscriptAudioFilesRequest withCallId(Optional<? extends List<String>> callId) {
        Utils.checkNotNull(callId, "callId");
        this.callId = callId;
        return this;
    }
     ...
     * Page
     */
    public GetEarningsCallTranscriptAudioFilesRequest withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page
     */
    public GetEarningsCallTranscriptAudioFilesRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Page Size
     */
    public GetEarningsCallTranscriptAudioFilesRequest withPagesize(long pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
     ...
     * Page Size
     */
    public GetEarningsCallTranscriptAudioFilesRequest withPagesize(Optional<Long> pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
        this.pagesize = pagesize;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEarningsCallTranscriptAudioFilesRequest other = (GetEarningsCallTranscriptAudioFilesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEarningsCallTranscriptAudioFilesRequest.class,
                "tickers", tickers,
                "callId", callId,
                "page", page,
                "pagesize", pagesize);
    ...
    public final static class Builder {
        ...
        public GetEarningsCallTranscriptAudioFilesRequest build() {
            return new GetEarningsCallTranscriptAudioFilesRequest(
                tickers,
                callId,
                page,
                pagesize);
