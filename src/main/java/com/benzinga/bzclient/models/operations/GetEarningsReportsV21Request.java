...
public class GetEarningsReportsV21Request {
    ...
    @JsonCreator
    public GetEarningsReportsV21Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetEarningsReportsV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetEarningsReportsV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetEarningsReportsV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetEarningsReportsV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetEarningsReportsV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetEarningsReportsV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetEarningsReportsV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEarningsReportsV21Request other = (GetEarningsReportsV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEarningsReportsV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetEarningsReportsV21Request build() {
            return new GetEarningsReportsV21Request(
                symbols,
                asOf,
                period,
                reportType);
