...
public class GetTickerTrendDataRequest {
    ...
    @JsonCreator
    public GetTickerTrendDataRequest(
            String interval,
            String tickers,
            String source,
     ...
     * Interval for the data
     */
    public GetTickerTrendDataRequest withInterval(String interval) {
        Utils.checkNotNull(interval, "interval");
        this.interval = interval;
        return this;
    }
     ...
     * Comma separated list of tickers
     */
    public GetTickerTrendDataRequest withTickers(String tickers) {
        Utils.checkNotNull(tickers, "tickers");
        this.tickers = tickers;
        return this;
    }
     ...
     * Source of the data
     */
    public GetTickerTrendDataRequest withSource(String source) {
        Utils.checkNotNull(source, "source");
        this.source = source;
        return this;
    }
     ...
     * Timeframe for the data
     */
    public GetTickerTrendDataRequest withTimeframe(String timeframe) {
        Utils.checkNotNull(timeframe, "timeframe");
     ...
     * Timeframe for the data
     */
    public GetTickerTrendDataRequest withTimeframe(Optional<String> timeframe) {
        Utils.checkNotNull(timeframe, "timeframe");
        this.timeframe = timeframe;
        return this;
    }
     ...
     * Page number
     */
    public GetTickerTrendDataRequest withPage(long page) {
        Utils.checkNotNull(page, "page");
     ...
     * Page number
     */
    public GetTickerTrendDataRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Page size
     */
    public GetTickerTrendDataRequest withPagesize(long pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
     ...
     * Page size
     */
    public GetTickerTrendDataRequest withPagesize(Optional<Long> pagesize) {
        Utils.checkNotNull(pagesize, "pagesize");
        this.pagesize = pagesize;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTickerTrendDataRequest other = (GetTickerTrendDataRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTickerTrendDataRequest.class,
                "interval", interval,
                "tickers", tickers,
                "source", source,
                "timeframe", timeframe,
    ...
    public final static class Builder {
        ...
        public GetTickerTrendDataRequest build() {
            return new GetTickerTrendDataRequest(
                interval,
                tickers,
                source,
                timeframe,
