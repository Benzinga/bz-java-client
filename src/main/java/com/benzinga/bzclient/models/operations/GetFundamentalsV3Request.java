...
public class GetFundamentalsV3Request {
    ...
    @JsonCreator
    public GetFundamentalsV3Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetFundamentalsV3Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * From date
     */
    public GetFundamentalsV3Request withFrom(String from) {
        Utils.checkNotNull(from, "from");
     ...
     * From date
     */
    public GetFundamentalsV3Request withFrom(Optional<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
     ...
     * To date
     */
    public GetFundamentalsV3Request withTo(String to) {
        Utils.checkNotNull(to, "to");
     ...
     * To date
     */
    public GetFundamentalsV3Request withTo(Optional<String> to) {
        Utils.checkNotNull(to, "to");
        this.to = to;
        return this;
    }
     ...
     * Report Type
     */
    public GetFundamentalsV3Request withDate(String date) {
        Utils.checkNotNull(date, "date");
     ...
     * Report Type
     */
    public GetFundamentalsV3Request withDate(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFundamentalsV3Request other = (GetFundamentalsV3Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFundamentalsV3Request.class,
                "symbols", symbols,
                "from", from,
                "to", to,
                "date", date);
    ...
    public final static class Builder {
        ...
        public GetFundamentalsV3Request build() {
            return new GetFundamentalsV3Request(
                symbols,
                from,
                to,
                date);
