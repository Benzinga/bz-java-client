...
public class GetCashFlowV3RequestBuilder {
    ...
    public GetCashFlowV3RequestBuilder symbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
                
    public GetCashFlowV3RequestBuilder from(String from) {
        Utils.checkNotNull(from, "from");
        this.from = Optional.of(from);
        return this;
    }

    public GetCashFlowV3RequestBuilder from(Optional<String> from) {
        Utils.checkNotNull(from, "from");
        this.from = from;
        return this;
    }
                
    public GetCashFlowV3RequestBuilder to(String to) {
        Utils.checkNotNull(to, "to");
        this.to = Optional.of(to);
        return this;
    }

    public GetCashFlowV3RequestBuilder to(Optional<String> to) {
        Utils.checkNotNull(to, "to");
        this.to = to;
        return this;
    }
                
    public GetCashFlowV3RequestBuilder date(String date) {
        Utils.checkNotNull(date, "date");
        this.date = Optional.of(date);
        return this;
    }

    public GetCashFlowV3RequestBuilder date(Optional<String> date) {
        Utils.checkNotNull(date, "date");
        this.date = date;
        return this;
    }
