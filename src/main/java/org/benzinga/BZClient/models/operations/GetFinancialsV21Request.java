...
public class GetFinancialsV21Request {
    ...
    @JsonCreator
    public GetFinancialsV21Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetFinancialsV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetFinancialsV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetFinancialsV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetFinancialsV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetFinancialsV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetFinancialsV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetFinancialsV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFinancialsV21Request other = (GetFinancialsV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFinancialsV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetFinancialsV21Request build() {
            return new GetFinancialsV21Request(
                symbols,
                asOf,
                period,
                reportType);
