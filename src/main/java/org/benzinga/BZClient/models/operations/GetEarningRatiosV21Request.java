...
public class GetEarningRatiosV21Request {
    ...
    @JsonCreator
    public GetEarningRatiosV21Request(
     ...
     * Comma separated list of symbols
     */
    public GetEarningRatiosV21Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
     ...
     * Comma separated list of symbols
     */
    public GetEarningRatiosV21Request withSymbols(Optional<String> symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetEarningRatiosV21Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetEarningRatiosV21Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetEarningRatiosV21Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetEarningRatiosV21Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetEarningRatiosV21Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetEarningRatiosV21Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetEarningRatiosV21Request other = (GetEarningRatiosV21Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetEarningRatiosV21Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetEarningRatiosV21Request build() {
            return new GetEarningRatiosV21Request(
                symbols,
                asOf,
                period,
                reportType);
