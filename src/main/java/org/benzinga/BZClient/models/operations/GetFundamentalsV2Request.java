...
public class GetFundamentalsV2Request {
    ...
    @JsonCreator
    public GetFundamentalsV2Request(
            String symbols,
     ...
     * Comma separated list of symbols
     */
    public GetFundamentalsV2Request withSymbols(String symbols) {
        Utils.checkNotNull(symbols, "symbols");
        this.symbols = symbols;
        return this;
    }
     ...
     * As of date
     */
    public GetFundamentalsV2Request withAsOf(String asOf) {
        Utils.checkNotNull(asOf, "asOf");
     ...
     * As of date
     */
    public GetFundamentalsV2Request withAsOf(Optional<String> asOf) {
        Utils.checkNotNull(asOf, "asOf");
        this.asOf = asOf;
        return this;
    }
     ...
     * Period
     */
    public GetFundamentalsV2Request withPeriod(String period) {
        Utils.checkNotNull(period, "period");
     ...
     * Period
     */
    public GetFundamentalsV2Request withPeriod(Optional<String> period) {
        Utils.checkNotNull(period, "period");
        this.period = period;
        return this;
    }
     ...
     * Report Type
     */
    public GetFundamentalsV2Request withReportType(String reportType) {
        Utils.checkNotNull(reportType, "reportType");
     ...
     * Report Type
     */
    public GetFundamentalsV2Request withReportType(Optional<String> reportType) {
        Utils.checkNotNull(reportType, "reportType");
        this.reportType = reportType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetFundamentalsV2Request other = (GetFundamentalsV2Request) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetFundamentalsV2Request.class,
                "symbols", symbols,
                "asOf", asOf,
                "period", period,
    ...
    public final static class Builder {
        ...
        public GetFundamentalsV2Request build() {
            return new GetFundamentalsV2Request(
                symbols,
                asOf,
                period,
                reportType);
